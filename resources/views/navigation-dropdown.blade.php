<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="flex-shrink-0 flex items-center" style="font-size: 1.2rem">
                    <a href="{{ url('/') }}">
                        @include('logo')
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6"> 
                @can('edit-data', Auth::user())
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex sm:mr-6">
                        <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                            {{ __('Dashboard') }}
                        </x-jet-nav-link>
                    </div>
                @else
                    <div class="hidden sm:flex sm:mr-6">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-jet-responsive-nav-link href="{{ route('loans') }}" :active="request()->routeIs('loans')">
                    {{ __('Loans') }}
                </x-jet-responsive-nav-link>
